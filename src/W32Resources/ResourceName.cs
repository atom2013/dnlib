...
namespace dnlib.W32Resources {
	...
	public struct ResourceName : IComparable<ResourceName>, IEquatable<ResourceName> {
		...
		/// </summary>
		public bool HasId { get { return name == null; } }
		...
		public static implicit operator ResourceName(int id) { return new ResourceName(id); }

		/// <summary>Converts input to a <see cref="ResourceName"/></summary>
		public static implicit operator ResourceName(string name) { return new ResourceName(name); }

		/// <summary>Overloaded operator</summary>
		public static bool operator <(ResourceName left, ResourceName right) { return left.CompareTo(right) < 0; }
		...
		/// <summary>Overloaded operator</summary>
		public static bool operator ==(ResourceName left, ResourceName right) { return left.Equals(right); }
		...
		/// <inheritdoc/>
		public bool Equals(ResourceName other) { return CompareTo(other) == 0; }
		...
		/// <inheritdoc/>
        public override string ToString() { return HasId ? id.ToString() : name; }
	}
}
