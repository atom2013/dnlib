...
namespace dnlib.DotNet {
	...
	public static partial class Extensions {
		...
		/// <param name="typeRef">The type</param>
		/// <returns>A <see cref="TypeDef"/> instance or <c>null</c> if it couldn't be resolved</returns>
		public static TypeDef Resolve(this ITypeResolver self, TypeRef typeRef) { return self.Resolve(typeRef, null); }
        ...
        public static TypeDef ResolveThrow(this ITypeResolver self, TypeRef typeRef) { return self.ResolveThrow(typeRef, null); }
		...
		public static FieldDef ResolveField(this IMemberRefResolver self, MemberRef memberRef) { return self.Resolve(memberRef) as FieldDef; }
		...
		public static FieldDef ResolveFieldThrow(this IMemberRefResolver self, MemberRef memberRef) {
            FieldDef field;
			if ((field = self.Resolve(memberRef) as FieldDef) != null)
				return field;
		...
		public static MethodDef ResolveMethod(this IMemberRefResolver self, MemberRef memberRef) { return self.Resolve(memberRef) as MethodDef; }
		...
		public static MethodDef ResolveMethodThrow(this IMemberRefResolver self, MemberRef memberRef) {
            MethodDef method;
			if ((method = self.Resolve(memberRef) as MethodDef) != null)
				return method;
