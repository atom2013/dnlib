...
namespace dnlib.DotNet {
	...
	public abstract class EventDef : IHasCustomAttribute, IHasSemantic, IHasCustomDebugInformation, IFullName, IMemberDef {
		...
		/// <inheritdoc/>
		public MDToken MDToken { get { return new MDToken(Table.Event, rid); } }
		...
		/// <inheritdoc/>
		public int HasCustomAttributeTag { get { return 10; } }

		/// <inheritdoc/>
		public int HasSemanticTag { get { return 0; } }
		...
		/// <inheritdoc/>
		public int HasCustomDebugInformationTag { get { return 10; } }
		...
		/// </summary>
		public string FullName { get { return FullNameFactory.EventFullName(declaringType2 != null?declaringType2.FullName:null, name, eventType, null, null); } }
		...
		bool IMemberRef.IsEventDef { get { return true; } }
	...
	sealed class EventDefMD : EventDef, IMDTokenProviderMD {
		...
		public EventDefMD(ModuleDefMD readerModule, uint rid) {
            ...
            RawEventRow row;
			bool b = readerModule.TablesStream.TryReadEventRow(origRid, out row);
			Debug.Assert(b);
