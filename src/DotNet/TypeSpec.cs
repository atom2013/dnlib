...
namespace dnlib.DotNet {
	...
	public abstract class TypeSpec : ITypeDefOrRef, IHasCustomAttribute, IMemberRefParent, IHasCustomDebugInformation {
		...
		/// <inheritdoc/>
		public int TypeDefOrRefTag { get { return 2; } }

		/// <inheritdoc/>
		public int HasCustomAttributeTag { get { return 13; } }

		/// <inheritdoc/>
		public int MemberRefParentTag { get { return 4; } }
		...
		ITypeDefOrRef IMemberRef.DeclaringType {
			get {
                ...
                GenericInstSig gis;
				if ((gis = sig as GenericInstSig) != null)
					sig = gis.GenericType;
		...
		bool IMemberRef.IsTypeSpec { get { return true; } }
		...
		/// <inheritdoc/>
		public int HasCustomDebugInformationTag { get { return 13; } }
	...
	sealed class TypeSpecMD : TypeSpec, IMDTokenProviderMD, IContainsGenericParameter2 {
        ...
        bool IContainsGenericParameter2.ContainsGenericParameter { get { return !gpContext.IsEmpty && ContainsGenericParameter; } }
		...
		public TypeSpecMD(ModuleDefMD readerModule, uint rid, GenericParamContext gpContext) {
            ...
            RawTypeSpecRow row;
			bool b = readerModule.TablesStream.TryReadTypeSpecRow(origRid, out row);
			Debug.Assert(b);
