...
namespace dnlib.DotNet {
	...
	public struct MDToken : IEquatable<MDToken>, IComparable<MDToken> {
		...
		/// </summary>
		public Table Table { get { return ToTable(token); } }

		/// <summary>
		/// Returns the row id
		/// </summary>
		public uint Rid { get { return ToRID(token); } }

		/// <summary>
		/// Returns the raw token
		/// </summary>
		public uint Raw { get { return token; } }

		/// <summary>
		/// Returns <c>true</c> if it's a <c>null</c> token
		/// </summary>
		public bool IsNull { get { return Rid == 0; } }
		...
		public static uint ToRID(uint token) { return token & RID_MASK; }
		...
		/// <param name="token">A raw metadata token</param>
		/// <returns>A <c>rid</c></returns>
		public static uint ToRID(int token) { return ToRID((uint)token); }
		...
		public static Table ToTable(uint token) { return (Table)(token >> TABLE_SHIFT); }
		...
		/// <param name="token">A raw metadata token</param>
		/// <returns>A metadata table index</returns>
		public static Table ToTable(int token) { return ToTable((uint)token); }

		/// <summary>
		/// Gets the token as a raw 32-bit signed integer
		/// </summary>
		public int ToInt32() { return (int)token; }

		/// <summary>
		/// Gets the token as a raw 32-bit unsigned integer
		/// </summary>
		public uint ToUInt32() { return token; }

		/// <summary>Overloaded operator</summary>
		public static bool operator ==(MDToken left, MDToken right) { return left.CompareTo(right) == 0; }
		...
		/// <inheritdoc/>
		public int CompareTo(MDToken other) { return token.CompareTo(other.token); }

		/// <inheritdoc/>
		public bool Equals(MDToken other) { return CompareTo(other) == 0; }
		...
		/// <inheritdoc/>
		public override int GetHashCode() { return (int)token; }

		/// <inheritdoc/>
        public override string ToString() { return token.ToString("X8"); }
	}
}
