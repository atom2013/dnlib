...
namespace dnlib.DotNet {
	...
	public abstract class ModuleDef : IHasCustomAttribute, IHasCustomDebugInformation, IResolutionScope, IDisposable, IListListener<TypeDef>, IModule, ITypeDefFinder, IDnlibDef, ITokenResolver, ISignatureReaderHelper {
		...
		/// <inheritdoc/>
		public MDToken MDToken { get { return new MDToken(Table.Module, rid); } }
		...
		/// <inheritdoc/>
		public int HasCustomAttributeTag { get { return 7; } }

		/// <inheritdoc/>
		public int ResolutionScopeTag { get { return 0; } }
		...
		/// <inheritdoc/>
		public ScopeType ScopeType { get { return ScopeType.ModuleDef; } }
		...
		/// <inheritdoc/>
		public int HasCustomDebugInformationTag { get { return 7; } }
		...
		protected virtual RVA GetNativeEntryPoint_NoLock() { return 0; }
		/// <summary>Called to initialize <see cref="managedEntryPoint"/></summary>
		protected virtual IManagedEntryPoint GetManagedEntryPoint_NoLock() { return null; }
		...
		/// </summary>
		public bool IsNativeEntryPointValid { get { return NativeEntryPoint != 0; } }

		/// <summary>
		/// <c>true</c> if <see cref="ManagedEntryPoint"/> is non-null
		/// </summary>
		public bool IsManagedEntryPointValid { get { return ManagedEntryPoint != null; } }

		/// <summary>
		/// <c>true</c> if <see cref="EntryPoint"/> is non-null
		/// </summary>
		public bool IsEntryPointValid { get { return EntryPoint != null; } }
		...
		protected virtual VTableFixups GetVTableFixups_NoLock() { return null; }

		/// <summary>
		/// <c>true</c> if there's at least one <see cref="TypeDef"/> in <see cref="Types"/>
		/// </summary>
		public bool HasTypes { get { return Types.Count > 0; } }

		/// <summary>
		/// <c>true</c> if there's at least one <see cref="ExportedType"/> in <see cref="ExportedTypes"/>
		/// </summary>
		public bool HasExportedTypes { get { return ExportedTypes.Count > 0; } }

		/// <summary>
		/// <c>true</c> if there's at least one <see cref="Resource"/> in <see cref="Resources"/>
		/// </summary>
		public bool HasResources { get { return Resources.Count > 0; } }
		...
		/// </summary>
		public ICorLibTypes CorLibTypes { get { return corLibTypes; } }
		...
		/// </summary>
		public TypeDef GlobalType { get { return Types.Count == 0 ? null : Types[0]; } }
		...
		protected virtual Win32Resources GetWin32Resources_NoLock() { return null; }
		...
		/// </summary>
		public PdbState PdbState { get { return pdbState; } }
		...
		/// </summary>
		public bool IsWinMD { get { return WinMDStatus != WinMDStatus.None; } }

		/// <summary>
		/// <c>true</c> if this is a managed WinMD file
		/// </summary>
		public bool IsManagedWinMD { get { return WinMDStatus == WinMDStatus.Managed; } }

		/// <summary>
		/// <c>true</c> if this is a pure (non-managed) WinMD file
		/// </summary>
		public bool IsPureWinMD { get { return WinMDStatus == WinMDStatus.Pure; } }
		...
		/// </summary>
		public bool IsClr10Exactly { get { return
		...
		/// and minor version numbers are checked)
		/// </summary>
		public bool IsClr11 { get { return (RuntimeVersion ?? string.Empty).StartsWith(MDHeaderRuntimeVersion.MS_CLR_11_PREFIX); } }

		/// <summary>
		/// <c>true</c> if <see cref="RuntimeVersion"/> is the CLR v1.1 string
		/// </summary>
		public bool IsClr11Exactly { get { return RuntimeVersion == MDHeaderRuntimeVersion.MS_CLR_11; } }
		...
		/// </summary>
		public bool IsClr1xExactly { get { return IsClr10Exactly || IsClr11Exactly; } }

		/// <summary>
		/// <c>true</c> if <see cref="RuntimeVersion"/> is the CLR v2.0 string (only the major
		/// and minor version numbers are checked)
		/// </summary>
		public bool IsClr20 { get { return (RuntimeVersion ?? string.Empty).StartsWith(MDHeaderRuntimeVersion.MS_CLR_20_PREFIX); } }

		/// <summary>
		/// <c>true</c> if <see cref="RuntimeVersion"/> is the CLR v2.0 string
		/// </summary>
		public bool IsClr20Exactly { get { return RuntimeVersion == MDHeaderRuntimeVersion.MS_CLR_20; } }

		/// <summary>
		/// <c>true</c> if <see cref="RuntimeVersion"/> is the CLR v4.0 string (only the major
		/// and minor version numbers are checked)
		/// </summary>
		public bool IsClr40 { get { return (RuntimeVersion ?? string.Empty).StartsWith(MDHeaderRuntimeVersion.MS_CLR_40_PREFIX); } }

		/// <summary>
		/// <c>true</c> if <see cref="RuntimeVersion"/> is the CLR v4.0 string
		/// </summary>
		public bool IsClr40Exactly { get { return RuntimeVersion == MDHeaderRuntimeVersion.MS_CLR_40; } }

		/// <summary>
		/// <c>true</c> if <see cref="RuntimeVersion"/> is the ECMA 2002 string
		/// </summary>
		public bool IsEcma2002 { get { return RuntimeVersion == MDHeaderRuntimeVersion.ECMA_2002; } }

		/// <summary>
		/// <c>true</c> if <see cref="RuntimeVersion"/> is the ECMA 2005 string
		/// </summary>
		public bool IsEcma2005 { get { return RuntimeVersion == MDHeaderRuntimeVersion.ECMA_2005; } }
		...
		public bool Is32BitRequired {
			get { return ((ComImageFlags)cor20HeaderFlags & ComImageFlags.Bit32Required) != 0; }
		...
		public bool Is32BitPreferred {
			get { return ((ComImageFlags)cor20HeaderFlags & ComImageFlags.Bit32Preferred) != 0; }
		...
		protected virtual void Dispose(bool disposing) {
			...
			if (pdbState != null) pdbState.Dispose();
			pdbState = null;
		}
		...
		/// </summary>
		public IEnumerable<TypeDef> GetTypes() { return AllTypesHelper.Types(Types); }
		...
		public ITypeDefOrRef Import(Type type) { return new Importer(this).Import(type); }
		...
		/// <param name="type">The type</param>
		/// <returns>The imported type or <c>null</c> if <paramref name="type"/> is invalid</returns>
		public TypeSig ImportAsTypeSig(Type type) { return new Importer(this).ImportAsTypeSig(type); }
		...
		public MemberRef Import(FieldInfo fieldInfo) { return (MemberRef)new Importer(this).Import(fieldInfo); }
		...
		public IMethod Import(MethodBase methodBase) { return new Importer(this).Import(methodBase); }
		...
		public IType Import(IType type) { return new Importer(this).Import(type); }
		...
		/// <param name="type">The type</param>
		/// <returns>The imported type or <c>null</c></returns>
		public TypeRef Import(TypeDef type) { return (TypeRef)new Importer(this).Import(type); }
		...
		/// <param name="type">The type</param>
		/// <returns>The imported type or <c>null</c></returns>
		public TypeRef Import(TypeRef type) { return (TypeRef)new Importer(this).Import(type); }
		...
		/// <param name="type">The type</param>
		/// <returns>The imported type or <c>null</c></returns>
		public TypeSpec Import(TypeSpec type) { return new Importer(this).Import(type); }
		...
		/// <param name="type">The type</param>
		/// <returns>The imported type or <c>null</c></returns>
		public TypeSig Import(TypeSig type) { return new Importer(this).Import(type); }
		...
		public MemberRef Import(IField field) { return (MemberRef)new Importer(this).Import(field); }
		...
		/// <param name="field">The field</param>
		/// <returns>The imported type or <c>null</c> if <paramref name="field"/> is invalid</returns>
		public MemberRef Import(FieldDef field) { return (MemberRef)new Importer(this).Import(field); }
		...
		public IMethod Import(IMethod method) { return new Importer(this).Import(method); }
		...
		/// <param name="method">The method</param>
		/// <returns>The imported method or <c>null</c> if <paramref name="method"/> is invalid</returns>
		public MemberRef Import(MethodDef method) { return (MemberRef)new Importer(this).Import(method); }
		...
		/// <param name="method">The method</param>
		/// <returns>The imported method or <c>null</c> if <paramref name="method"/> is invalid</returns>
		public MethodSpec Import(MethodSpec method) { return new Importer(this).Import(method); }
		...
		public MemberRef Import(MemberRef memberRef) { return new Importer(this).Import(memberRef); }
		...
		public ResourceData FindWin32ResourceData(ResourceName type, ResourceName name, ResourceName langId) { return Win32Resources != null?Win32Resources.Find(type, name, langId):null; }
		...
		public int GetPointerSize() { return GetPointerSize(4); }
		...
		/// <returns>Size of a pointer (4 or 8)</returns>
		public int GetPointerSize(int defaultPointerSize) { return GetPointerSize(defaultPointerSize, defaultPointerSize); }
		...
		public TypeDef Find(string fullName, bool isReflectionName) { return TypeDefFinder.Find(fullName, isReflectionName); }
		...
		/// <returns>An existing <see cref="TypeDef"/> or <c>null</c> if it wasn't found.</returns>
		public TypeDef Find(TypeRef typeRef) { return TypeDefFinder.Find(typeRef); }
		...
		public TypeDef Find(ITypeDefOrRef typeRef) {
            TypeDef td;
            if ((td = typeRef as TypeDef) != null)
				return td.Module == this ? td : null;

            TypeRef tr;
            if ((tr = typeRef as TypeRef) != null)
				return Find(tr);
		...
		public virtual void LoadEverything(ICancellationToken cancellationToken) { ModuleLoader.LoadAll(this, cancellationToken); }

        /// <summary>
		/// Load everything in this module. All types, fields, asm refs, etc are loaded, all their
		/// properties are read to make sure everything is cached.
		/// </summary>
		public virtual void LoadEverything() { LoadEverything(null); }
		...
		public IMDTokenProvider ResolveToken(MDToken mdToken) { return ResolveToken(mdToken.Raw, new GenericParamContext()); }
		...
		/// <returns>A <see cref="IMDTokenProvider"/> or <c>null</c> if <paramref name="mdToken"/> is invalid</returns>
		public IMDTokenProvider ResolveToken(MDToken mdToken, GenericParamContext gpContext) { return ResolveToken(mdToken.Raw, gpContext); }
		...
		public IMDTokenProvider ResolveToken(int token) { return ResolveToken((uint)token, new GenericParamContext()); }
		...
		/// <param name="gpContext">Generic parameter context</param>
		/// <returns>A <see cref="IMDTokenProvider"/> or <c>null</c> if <paramref name="token"/> is invalid</returns>
		public IMDTokenProvider ResolveToken(int token, GenericParamContext gpContext) { return ResolveToken((uint)token, gpContext); }
		...
		/// <param name="token">The metadata token</param>
		/// <returns>A <see cref="IMDTokenProvider"/> or <c>null</c> if <paramref name="token"/> is invalid</returns>
		public IMDTokenProvider ResolveToken(uint token) { return ResolveToken(token, new GenericParamContext()); }
		...
		/// <param name="gpContext">Generic parameter context</param>
		/// <returns>A <see cref="IMDTokenProvider"/> or <c>null</c> if <paramref name="token"/> is invalid</returns>
		public virtual IMDTokenProvider ResolveToken(uint token, GenericParamContext gpContext) { return null; }
		...
		/// </summary>
		public IEnumerable<MemberRef> GetMemberRefs() { return GetMemberRefs(new GenericParamContext()); }
		...
		TypeSig ISignatureReaderHelper.ConvertRTInternalAddress(IntPtr address) { return null; }
	}
	...
	public class ModuleDefMD2 : ModuleDef, IMDTokenProviderMD {
		...
		/// <inheritdoc/>
		protected override RVA GetNativeEntryPoint_NoLock() { return readerModule.GetNativeEntryPoint(); }

		/// <inheritdoc/>
		protected override IManagedEntryPoint GetManagedEntryPoint_NoLock() { return readerModule.GetManagedEntryPoint(); }
		...
		protected void InitializeFromRawRow() {
            RawModuleRow row;
            bool b = readerModule.TablesStream.TryReadModuleRow(origRid, out row);
			Debug.Assert(b);
