...
namespace dnlib.DotNet.MD {
	...
	public sealed class RawRowEqualityComparer : IEqualityComparer<RawModuleRow>,
		...
		static int rol(uint val, int shift) { return (int)((val << shift) | (val >> (32 - shift))); }
		...
		public bool Equals(RawFieldPtrRow x, RawFieldPtrRow y) { return x.Field == y.Field; }

		public int GetHashCode(RawFieldPtrRow obj) { return (int)obj.Field; }
		...
		public bool Equals(RawMethodPtrRow x, RawMethodPtrRow y) { return x.Method == y.Method; }

		public int GetHashCode(RawMethodPtrRow obj) { return (int)obj.Method; }
		...
		public bool Equals(RawParamPtrRow x, RawParamPtrRow y) { return x.Param == y.Param; }

		public int GetHashCode(RawParamPtrRow obj) { return (int)obj.Param; }
		...
		public bool Equals(RawEventPtrRow x, RawEventPtrRow y) { return x.Event == y.Event; }

		public int GetHashCode(RawEventPtrRow obj) { return (int)obj.Event; }
		...
		public bool Equals(RawPropertyPtrRow x, RawPropertyPtrRow y) { return x.Property == y.Property; }

		public int GetHashCode(RawPropertyPtrRow obj) { return (int)obj.Property; }
		...
		public bool Equals(RawModuleRefRow x, RawModuleRefRow y) { return x.Name == y.Name; }

		public int GetHashCode(RawModuleRefRow obj) { return (int)obj.Name; }

		public bool Equals(RawTypeSpecRow x, RawTypeSpecRow y) { return x.Signature == y.Signature; }

		public int GetHashCode(RawTypeSpecRow obj) { return (int)obj.Signature; }
		...
		public bool Equals(RawENCMapRow x, RawENCMapRow y) { return x.Token == y.Token; }

		public int GetHashCode(RawENCMapRow obj) { return (int)obj.Token; }
		...
		public bool Equals(RawAssemblyProcessorRow x, RawAssemblyProcessorRow y) { return x.Processor == y.Processor; }

		public int GetHashCode(RawAssemblyProcessorRow obj) { return (int)obj.Processor; }
