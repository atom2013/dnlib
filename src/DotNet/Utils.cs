...
namespace dnlib.DotNet {
	...
	sealed class ByteArrayEqualityComparer : IEqualityComparer<byte[]> {
		...
		/// <inheritdoc/>
		public bool Equals(byte[] x, byte[] y) { return Utils.Equals(x, y); }

		/// <inheritdoc/>
		public int GetHashCode(byte[] obj) { return Utils.GetHashCode(obj); }
	}
	...
	static class Utils {
		...
		/// <param name="b">Version #2 or <c>null</c> to be treated as v0.0.0.0</param>
		/// <returns><c>true</c> if same, <c>false</c> otherwise</returns>
        internal static bool Equals(Version a, Version b) { return CompareTo(a, b) == 0; }
		...
		static int GetDefaultVersionValue(int val) { return val == -1 ? 0 : val; }
		...
		/// <param name="b">Second</param>
		/// <returns>&lt; 0 if a &lt; b, 0 if a == b, &gt; 0 if a &gt; b</returns>
		internal static int LocaleCompareTo(UTF8String a, UTF8String b) { return GetCanonicalLocale(a).CompareTo(GetCanonicalLocale(b)); }
		...
		/// <param name="b">Second</param>
		/// <returns><c>true</c> if same, <c>false</c> otherwise</returns>
		internal static bool LocaleEquals(UTF8String a, UTF8String b) { return LocaleCompareTo(a, b) == 0; }
		...
		/// <param name="b">Second</param>
		/// <returns>&lt; 0 if a &lt; b, 0 if a == b, &gt; 0 if a &gt; b</returns>
		internal static int LocaleCompareTo(UTF8String a, string b) { return GetCanonicalLocale(a).CompareTo(GetCanonicalLocale(b)); }
		...
		/// <param name="b">Second</param>
		/// <returns><c>true</c> if same, <c>false</c> otherwise</returns>
		internal static bool LocaleEquals(UTF8String a, string b) { return LocaleCompareTo(a, b) == 0; }
		...
		/// <returns>The hash code</returns>
		internal static int GetHashCodeLocale(UTF8String a) { return GetCanonicalLocale(a).GetHashCode(); }
		...
		public static uint AlignUp(uint v, uint alignment) { return (v + alignment - 1) & ~(alignment - 1); }
		...
		/// <param name="v">Value</param>
		/// <param name="alignment">Alignment</param>
		public static int AlignUp(int v, uint alignment) { return (int)AlignUp((uint)v, alignment); }
	}
}
