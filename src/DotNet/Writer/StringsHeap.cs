...
namespace dnlib.DotNet.Writer {
	...
	public sealed class StringsHeap : HeapBase, IOffsetHeap<UTF8String> {
		...
		sealed class StringsOffsetInfo {
			...
			public override string ToString() { return string.Format( "{0:X8} {1:X4} {2}", StringsId, StringsOffset, Value.String ); }
		}

		/// <inheritdoc/>
		public override string Name { get { return "#Strings"; } }
		...
		/// <inheritdoc/>
        public int GetRawDataSize(UTF8String data) { return data.Data.Length + 1; }
