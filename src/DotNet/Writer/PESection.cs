...
namespace dnlib.DotNet.Writer {
	...
	public sealed class PESection : ChunkList<IChunk> {
		...
		/// </summary>
		public bool IsCode { get { return (characteristics & 0x20) != 0; } }

		/// <summary>
		/// <c>true</c> if this is an initialized data section
		/// </summary>
		public bool IsInitializedData { get { return (characteristics & 0x40) != 0; } }

		/// <summary>
		/// <c>true</c> if this is an uninitialized data section
		/// </summary>
        public bool IsUninitializedData { get { return (characteristics & 0x80) != 0; } }
