...
namespace dnlib.DotNet {
	...
	public abstract class TypeRef : ITypeDefOrRef, IHasCustomAttribute, IMemberRefParent, IHasCustomDebugInformation, IResolutionScope {
		...
		/// <inheritdoc/>
		public MDToken MDToken { get { return new MDToken(Table.TypeRef, rid); } }
		...
		/// <inheritdoc/>
		public int TypeDefOrRefTag { get { return 1; } }

		/// <inheritdoc/>
		public int HasCustomAttributeTag { get { return 2; } }

		/// <inheritdoc/>
		public int MemberRefParentTag { get { return 1; } }

		/// <inheritdoc/>
		public int ResolutionScopeTag { get { return 3; } }
		...
		protected virtual IResolutionScope GetResolutionScope_NoLock() { return null; }
		...
		/// <inheritdoc/>
		public int HasCustomDebugInformationTag { get { return 2; } }
		...
		/// </summary>
		public TypeRef DeclaringType { get { return ResolutionScope as TypeRef; } }
		...
		bool IMemberRef.IsTypeRef { get { return true; } }
		...
		public TypeDef ResolveThrow() { return ResolveThrow(null); }
	...
	sealed class TypeRefMD : TypeRef, IMDTokenProviderMD {
		...
		/// <inheritdoc/>
        protected override IResolutionScope GetResolutionScope_NoLock() { return readerModule.ResolveResolutionScope(resolutionScopeCodedToken); }
		...
		public TypeRefMD(ModuleDefMD readerModule, uint rid) {
			...
			module = readerModule;
            RawTypeRefRow row;
			bool b = readerModule.TablesStream.TryReadTypeRefRow(origRid, out row);
			Debug.Assert(b);
