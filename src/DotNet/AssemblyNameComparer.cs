...
namespace dnlib.DotNet {
	...
	public struct AssemblyNameComparer : IEqualityComparer<IAssembly> {
		...
		/// </summary>
		public bool CompareName { get { return (flags & AssemblyNameComparerFlags.Name) != 0; } }

		/// <summary>
		/// Gets the <see cref="AssemblyNameComparerFlags.Version"/> bit
		/// </summary>
		public bool CompareVersion { get { return (flags & AssemblyNameComparerFlags.Version) != 0; } }

		/// <summary>
		/// Gets the <see cref="AssemblyNameComparerFlags.PublicKeyToken"/> bit
		/// </summary>
		public bool ComparePublicKeyToken { get { return (flags & AssemblyNameComparerFlags.PublicKeyToken) != 0; } }

		/// <summary>
		/// Gets the <see cref="AssemblyNameComparerFlags.Culture"/> bit
		/// </summary>
		public bool CompareCulture { get { return (flags & AssemblyNameComparerFlags.Culture) != 0; } }

		/// <summary>
		/// Gets the <see cref="AssemblyNameComparerFlags.ContentType"/> bit
		/// </summary>
		public bool CompareContentType { get { return (flags & AssemblyNameComparerFlags.ContentType) != 0; } }
        ...
        public bool Equals(IAssembly a, IAssembly b) { return CompareTo(a, b) == 0; }
