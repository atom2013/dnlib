...
namespace dnlib.DotNet {
	...
	public class MarshalType {
		...
		/// </summary>
		public NativeType NativeType { get { return nativeType; } }
		...
		/// <inheritdoc/>
		public override string ToString() { return nativeType.ToString(); }
	}
	...
	public sealed class FixedSysStringMarshalType : MarshalType {
		...
		/// </summary>
		public bool IsSizeValid { get { return size >= 0; } }
	...
	public sealed class SafeArrayMarshalType : MarshalType {
		...
		/// </summary>
		public bool IsVariantTypeValid { get { return vt != VariantType.NotInitialized; } }

		/// <summary>
		/// <c>true</c> if <see cref="UserDefinedSubType"/> is valid
		/// </summary>
		public bool IsUserDefinedSubTypeValid { get { return userDefinedSubType != null; } }
	...
	public sealed class FixedArrayMarshalType : MarshalType {
		...
		/// </summary>
		public bool IsElementTypeValid { get { return elementType != NativeType.NotInitialized; } }
		...
		/// <inheritdoc/>
		public override string ToString() { return string.Format( "{0} ({1}, {2})", nativeType, size, elementType ); }
	}
	...
	public sealed class ArrayMarshalType : MarshalType {
		...
		/// </summary>
		public bool IsParamNumberValid { get { return paramNum >= 0; } }

		/// <summary>
		/// <c>true</c> if <see cref="Size"/> is valid
		/// </summary>
		public bool IsSizeValid { get { return numElems >= 0; } }

		/// <summary>
		/// <c>true</c> if <see cref="Flags"/> is valid
		/// </summary>
		public bool IsFlagsValid { get { return flags >= 0; } }
		...
		/// </summary>
		public bool IsSizeParamIndexSpecified { get { return IsFlagsValid && (flags & ntaSizeParamIndexSpecified) != 0; } }

		/// <summary>
		/// <c>true</c> if <c>ntaSizeParamIndexSpecified</c> bit is not set, <c>false</c> if it's
		/// set or if <see cref="Flags"/> is invalid.
		/// </summary>
		public bool IsSizeParamIndexNotSpecified { get { return IsFlagsValid && (flags & ntaSizeParamIndexSpecified) == 0; } }
		...
		/// <inheritdoc/>
		public override string ToString() { return string.Format( "{0} ({1}, {2}, {3}, {4})", nativeType, elementType, paramNum, numElems, flags ); }
	}
	...
	public sealed class CustomMarshalType : MarshalType {
		...
		/// <inheritdoc/>
		public override string ToString() { return string.Format( "{0} ({1}, {2}, {3}, {4})", nativeType, guid, nativeTypeName, custMarshaler, cookie ); }
	}
	...
	public sealed class InterfaceMarshalType : MarshalType {
		...
		/// </summary>
		public bool IsIidParamIndexValid { get { return iidParamIndex >= 0; } }
		...
		/// <inheritdoc/>
        public override string ToString() { return string.Format("{0} ({1})", nativeType, iidParamIndex); }
	}
}
